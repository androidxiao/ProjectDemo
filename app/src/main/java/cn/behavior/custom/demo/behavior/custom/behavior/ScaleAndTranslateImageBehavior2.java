...
public class ScaleAndTranslateImageBehavior2 extends CoordinatorLayout.Behavior<View> {
    ...
    public ScaleAndTranslateImageBehavior2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    ...
    private void initProperties(View child, View dependency) {
        ...
        if (finalHeight == 0)
            finalHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.d_40);
