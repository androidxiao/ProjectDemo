...
public abstract class CommonRvAdapter<T> extends RecyclerView.Adapter<CommonViewHolder> {
    ...
    public CommonRvAdapter(Context context, List<T> dataList, int layoutId) {
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TextView tv= (TextView) itemView.findViewById(R.id.id_tv_test);
        mMoveViewList.add(tv);
        return holder;
    }
